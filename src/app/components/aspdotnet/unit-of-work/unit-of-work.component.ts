...
@Component({
  selector: 'app-unit-of-work',
  templateUrl: './unit-of-work.component.html',
  styleUrls: ['./unit-of-work.component.css']
})
export class UnitOfWorkComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    {
      private Entites _entites = new Entites();

      public void Add(Customer entity)
      {
        _entities.Customers.Add(entites);
      }
    ...
    public class UnitOfWork
    {
      ...
      private CustomerRepository _customersRepo;
      ...
      public CustomerRepository CustomersRepo
      {
        get
        {
          if(_customersRepo == null){
            _customersRepo = new CustomersRepository(_entities);
          }
      ...
      public OrdersRepository OrdersRepo
      {
        ...
        {
          if(_ordersRepo == null){
            _ordersRepo = new OrdersRepository(_entities);
          }
          return _ordersRepo;
        }
      }
    ...
    public class CustomersRepository
    {
      ...
      public CustomersRepository(Entities entities)
      {
        _entities = entities;
      }
    ...
    {
      UnitOfWork.UnitOfWork _unitOfWork = new UnitOfWork(new Entities());
      _unitOfWork.CustomersRepo.Add(
        new Customer
        {
          CustomerName = "Test Customer"
        }
      );
      _unitOfWork.OrdersRepo.Add(
        new Order
        {
          OrderNo = 465
        }
