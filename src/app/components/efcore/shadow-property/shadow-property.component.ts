...
@Component({
  selector: 'app-shadow-property',
  templateUrl: './shadow-property.component.html',
  styleUrls: ['./shadow-property.component.css']
})
export class ShadowPropertyComponent implements OnInit {
